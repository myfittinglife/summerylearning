...
import com.example.administrator.summarylearning.banneractivity.banner.transformer.CoverModeTransformer;
import com.example.administrator.summarylearning.banneractivity.banner.transformer.ScaleYTransformer;
...
public class BannerView<T> extends RelativeLayout {
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link BannerView {@link #setPages(List, BannerViewHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
     ...
     * @param mHolderCreator  ViewHolder生成器 {@link BannerViewHolderCreator} And {@link BannerViewHolder}
     */
    public void setPages(List<T> datas,BannerViewHolderCreator mHolderCreator){
        ...
        mAdapter = new BannerViewPagerAdapter<>(datas,mHolderCreator,mIsCanLoop);
    ...
    public static class  BannerViewPagerAdapter<T> extends PagerAdapter{
        private List<T> mDatas;
        private BannerViewHolderCreator mHolderCreator;
        private ViewPager mViewPager;
        private boolean canLoop;
        private BannerPageClickListener mPageClickListener;
        private final int mLooperCountFactor = 500;

        public BannerViewPagerAdapter(List<T> datas, BannerViewHolderCreator HolderCreator,boolean canLoop) {
            if(mDatas == null){
